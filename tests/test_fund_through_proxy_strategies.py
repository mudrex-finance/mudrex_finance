...
def test_add_strategy_wrong_token(fund_through_proxy, accounts, profit_strategy_10_token_2):
    with brownie.reverts("Fund underlying must match Strategy underlying"):
        fund_through_proxy.addStrategy(profit_strategy_10_token_2, 5000, 500, {'from': accounts[0]})
